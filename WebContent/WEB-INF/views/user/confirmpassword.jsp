			...
			<div
				...
				<div class="login-form">
					<div class="text-center">
						<strong><h3 style="color: darkred;">Xác thực</h3></strong>
						<p style="color: red;">${message}</p>
					</div>

					<c:set var="xacthuc" scope="session" value="" />
					<form action="user/confirm/${username}.htm">
						<input type="hidden" name="ma" value="${ma}" class="form-control"
							placeholder="Mã...">
						<div class="form-group">
							<h4 class="text-center"
								style="margin-top: 20px; margin-bottom: 10px;">Nhập mã xác
								thực</h4>
							<input type="text" name="xacthuc" value="${xacthuc}"
