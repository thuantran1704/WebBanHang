...
<body>
	...
	<div class="container" style="margin-top: 10px;">
		<div
			class="form-sec col-xs-12 col-sm-12 col-md-4 col-lg-5 col-lg-push-4 col-md-push-4">
			<div class="panel-heading text-center"
				style="color: chocolate; font-size: 20px;">Sửa sản phẩm</div>
			<h4 class="text-center">
				<img class="img-responsive" src="${product.anhSP}" />
			</h4>
			<p style="color: red;">${message}</p>
			<form:form method="post" action="product/update/${product.maSP}.htm"
				...
				<div class="form-group">
					<label>Ngày tạo:</label> <span style="color: red;">${message1}</span>
					<%-- <form:errors path="ngayTaoSP" style="color:red;"/> --%>
					<form:input path="ngayTaoSP" type="text" class="form-control"
						placeholder="Ngày tạo sản phẩm..." />
				</div>
				<div class="form-group">
				...
				<div class="text-center">
						<button type="submit" class="register-button mt-0">Cập
							nhật</button>
						
						<button class="register-button" > 
							<a href="product/index.htm" style="color: white;"> Hủy bỏ</a>
						</button>
				</div>
			</form:form>
		</div>
